...
double Marc(double bf0, double n, double PHI0, double PHI)
{
    ...
    */
    ...
    return bf0 * (((1.0 + n + ((5.0 / 4.0) * pow(n, 2.0)) + ((5.0 / 4.0) * pow(n, 3.0))) * (PHI - PHI0)) - (((3.0 * n) + (3.0 * pow(n, 2.0)) + ((21.0 / 8.0) * pow(n, 3.0))) * (sin(PHI - PHI0)) * (cos(PHI + PHI0))) + ((((15.0 / 8.0) * pow(n, 2.0)) + ((15.0 / 8.0) * pow(n, 3.0))) * (sin(2.0 * (PHI - PHI0))) * (cos(2.0 * (PHI + PHI0)))) - (((35.0 / 24.0) * pow(n, 3.0)) * (sin(3.0 * (PHI - PHI0))) * (cos(3.0 * (PHI + PHI0)))));
}
